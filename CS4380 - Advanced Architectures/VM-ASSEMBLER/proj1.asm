...
ADDB01	LDR R0, B0				;add 1st 2 elements of B together.
		...
		TRP 3
ADDB02	LDR R1, B2				;next element of B, etc
		LDR R0, ZERO
		ADD R2, R1
		ADD R0, R2
		TRP 1
		...
		TRP 3
		TRP 3
ADDB03	LDR R1, B3				;next element of B, etc
		LDR R0, ZERO
		ADD R2, R1
		ADD R0, R2
		TRP 1
		...
		TRP 3
		TRP 3
ADDB04	LDR R1, B4				;next element of B, etc
		LDR R0, ZERO
		ADD R2, R1
		ADD R0, R2
		TRP 1
		...
		TRP 3
		TRP 3
BFINAL	LDR R1, B5				;next element of B, etc
		LDR R0, ZERO
		ADD R2, R1
		ADD R0, R2
		TRP 1 					;print B Final
...
MULA01	LDR R0, A0				;multiply elements of A together.
		...
		TRP 3
		TRP 3
MULA12	LDR R1, A2				;next element of A, etc
		LDR R0, ZERO
		MUL R3, R1
		ADD R0, R3
		TRP 1
		...
		TRP 3
		TRP 3
MULA23	LDR R1, A3				;next element of A, etc
		LDR R0, ZERO
		MUL R3, R1
		ADD R0, R3
		TRP 1
		...
		TRP 3
		TRP 3
MULA34	LDR R1, A4				;next element of A, etc
		LDR R0, ZERO
		MUL R3, R1
		ADD R0, R3
		TRP 1
		...
		TRP 3
		TRP 3
AFINAL	LDR R1, A5				;next element of A, etc
		LDR R0, ZERO
		MUL R3, R1
		ADD R0, R3
		TRP 1
...
BLANK3	LDB R0, NEWLINE
		TRP 3
		TRP 3
DIVB0	LDR R0, ZERO			;Divide final results of B by each element of B.
		ADD R0, R2				;R2 holds BFinal.
		LDR R1, B0
		DIV R0, R1
		TRP 1
		LDB R0, SPACE
...
SUBC0	LDR R0, ZERO			;Subtract final result of A from each element of list C.
		...
		SUB R0, R1
		LDR R4, ZERO
		ADD R4, R0				;R4 Holds Cumulative(Final) Value of List C.
		TRP 1
		LDB R0, SPACE
		TRP 3
		TRP 3
...
SUBC3	LDR R0, ZERO
		...
		SUB R0, R1
		TRP 1
END		TRP 0					;End of Assembly Program.