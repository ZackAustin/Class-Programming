...
namespace TestHarness
{
    class Program    {   
        ...
        static void Main(string[] args)
        {
            ...
            string strConnString = @"Data Source=Zack;Initial Catalog=Company;Integrated Security=True";
        ...
        {
            Console.WriteLine("Employee Number - {0}", emp.EmpCode);
        ...
        /// <returns></returns>
        private static String SerializeXML(Objects.Employee emp)
        {
            try
            {
        ...
        private static void GenerateGetRequest()
        {
            ...
            string url = "http://localhost:8087/RestWebService/employee?id=3550";
