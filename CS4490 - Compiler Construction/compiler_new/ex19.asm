...
L334                      MOV R3, R7                   ; Set TRUE
                          ...
                          ADI R5, -16                  
                          STB R3, R5                   
L335                      MOV R1, FP                   ; BranchFalse T194, skipif195
                          ADI R1, -16                  
                          LDB R1, R1                   
...
L336                      MOV R3, R7                   ; Set TRUE
                          ...
                          ADI R5, -17                  
                          STB R3, R5                   
L337                      MOV R1, FP                   ; BranchFalse T197, skipif198
                          ADI R1, -17                  
                          LDB R1, R1                   
...
L338                      MOV R3, R7                   ; Set TRUE
                          ...
                          ADI R5, -13                  
                          STB R3, R5                   
L339                      MOV R1, FP                   ; BranchFalse T207, skipif208
                          ADI R1, -13                  
                          LDB R1, R1                   
...
g_iTree_insert            ADI SP, -81                  
                          ...
                          MOV R3, R1                   ; Move data into 3rd register for compare.
                          CMP R3, R2                   ; Compare Data.
                          BLT R3, L340                 ; P47 < T215 GOTO L340
                          MOV R3, R8                   ; Set FALSE
                          MOV R5, FP                   
                          ADI R5, -21                  
                          STB R3, R5                   
...
L340                      MOV R3, R7                   ; Set TRUE
                          ...
                          ADI R5, -21                  
                          STB R3, R5                   
L341                      MOV R1, FP                   ; BranchFalse T216, skipif217
                          ADI R1, -21                  
                          LDB R1, R1                   
                          ...
                          MOV R3, R1                   ; Move data into 3rd register for compare.
                          CMP R3, R2                   ; Compare Data.
                          BRZ R3, L342                 ; T218 < S10 GOTO L342
                          MOV R3, R8                   ; Set FALSE
                          MOV R5, FP                   
                          ADI R5, -26                  
                          STB R3, R5                   
...
L342                      MOV R3, R7                   ; Set TRUE
                          ...
                          ADI R5, -26                  
                          STB R3, R5                   
L343                      MOV R1, FP                   ; BranchFalse T219, skipif220
                          ADI R1, -26                  
                          LDB R1, R1                   
...
skipif217                 MOV R1, FP                   ; node + offset(root) -> T228
                          ...
                          MOV R3, R1                   ; Move data into 3rd register for compare.
                          CMP R3, R2                   ; Compare Data.
                          BGT R3, L344                 ; P47 < T228 GOTO L344
                          MOV R3, R8                   ; Set FALSE
                          MOV R5, FP                   
                          ADI R5, -51                  
                          STB R3, R5                   
...
L344                      MOV R3, R7                   ; Set TRUE
                          ...
                          ADI R5, -51                  
                          STB R3, R5                   
L345                      MOV R1, FP                   ; BranchFalse T229, skipif230
                          ADI R1, -51                  
                          LDB R1, R1                   
                          ...
                          MOV R3, R1                   ; Move data into 3rd register for compare.
                          CMP R3, R2                   ; Compare Data.
                          BRZ R3, L346                 ; T231 < S10 GOTO L346
                          MOV R3, R8                   ; Set FALSE
                          MOV R5, FP                   
                          ADI R5, -56                  
                          STB R3, R5                   
...
L346                      MOV R3, R7                   ; Set TRUE
                          ...
                          ADI R5, -56                  
                          STB R3, R5                   
L347                      MOV R1, FP                   ; BranchFalse T232, skipif233
                          ADI R1, -56                  
                          LDB R1, R1                   
...
L348                      MOV R3, R7                   ; Set TRUE
                          ...
                          ADI R5, -16                  
                          STB R3, R5                   
L349                      MOV R1, FP                   ; BranchFalse T245, skipif246
                          ADI R1, -16                  
                          LDB R1, R1                   
...
begin306                  MOV R1, FP                   ; i <= end -> T307
                          ...
                          MOV R3, R1                   ; Move data into 3rd register for compare.
                          CMP R3, R2                   ; Compare Data.
                          BLT R3, L350                 ; P144 < P145 GOTO L350
                          MOV R3, R1                   ; Move data into 3rd register for compare.
                          CMP R3, R2                   ; Compare Data.
                          BRZ R3, L350                 ; P144 < P145 GOTO L350
                          MOV R3, R8                   ; Set FALSE
                          MOV R5, FP                   
                          ADI R5, -20                  
                          STB R3, R5                   
...
L350                      MOV R3, R7                   ; Set TRUE
                          ...
                          ADI R5, -20                  
                          STB R3, R5                   
L351                      MOV R1, FP                   ; BranchFalse T307, endWhile308
                          ADI R1, -20                  
                          LDB R1, R1                   
...
g_main                    ADI SP, -63                  
                          ...
                          MOV R0, R1                   ; load byt for print.
                          TRP 3                        
begin331                  MOV R1, FP                   ; key != '!' -> T332
                          ADI R1, -12                  
                          LDB R1, R1                   
                          LDB R2, S185                 
                          MOV R3, R1                   ; Move data into 3rd register for compare.
                          CMP R3, R2                   ; Compare Data.
                          BNZ R3, L352                 ; L175 < S185 GOTO L352
                          MOV R3, R8                   ; Set FALSE
                          MOV R5, FP                   
                          ADI R5, -62                  
                          STB R3, R5                   
                          JMP L353                     
L352                      MOV R3, R7                   ; Set TRUE
                          MOV R5, FP                   
                          ADI R5, -62                  
                          STB R3, R5                   
L353                      MOV R1, FP                   ; BranchFalse T332, endWhile333
                          ADI R1, -62                  
                          LDB R1, R1                   
                          BNZ R1, endWhile333          ; Branch False
                          MOV R1, FP                   ; Read in char: L175
                          ADI R1, -12                  
                          LDB R1, R1                   
                          MOV R0, R1                   ; read byt for print.
                          ...
                          STB R0, R5                   
                          JMP begin331                 ; 
endWhile333               MOV SP, FP                   ; Test for Underflow
                          MOV R1, SP                   
                          CMP R1, SB                   
                          BGT R1, UNDERFLOW            
                          LDR R1, FP                   ; rtn addr
