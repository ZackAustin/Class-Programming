...
begin134                  MOV R1, FP                   ; i <= end -> T135
                          ...
                          BLT R3, L146                 ; P76 < P77 GOTO L146
                          MOV R3, R1                   ; Move data into 3rd register for compare.
                          CMP R3, R2                   ; Compare Data.
                          BRZ R3, L146                 ; P76 < P77 GOTO L146
                          MOV R3, R8                   ; Set FALSE
                          MOV R5, FP                   
                          ADI R5, -20                  
                          STB R3, R5                   
                          JMP L147                     
L146                      MOV R3, R7                   ; Set TRUE
                          MOV R5, FP                   
                          ADI R5, -20                  
                          STB R3, R5                   
L147                      MOV R1, FP                   ; BranchFalse T135, endWhile136
                          ADI R1, -20                  
                          LDB R1, R1                   
...
g_main                    ADI SP, -36                  
                          ...
                          MOV R2, FP                   
                          ADI R2, -19                  
                          STR R4, R2                   ; Store T141
                          MOV R1, SP                   ; Create an activation record T141
                          ...
                          ADI R4, -15                  
                          STR R1, R4                   
                          MOV R1, SP                   ; Create an activation record L84
