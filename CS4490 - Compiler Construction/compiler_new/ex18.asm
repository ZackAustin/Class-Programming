...
g_main                    ADI SP, -28                  
                          ...
                          ADI R2, -19                  
                          STR R4, R2                   ; Store T17
                          MOV R1, SP                   ; Create an activation record T17
                          ADI R1, -12                  ; Space for Function
                          CMP R1, SL                   ; Test Overflow
                          BLT R1, OVERFLOW             
                          MOV R9, FP                   ; Old Frame
                          ...
                          ADI R4, -15                  
                          STR R1, R4                   
                          MOV R1, SP                   ; Create an activation record L12
