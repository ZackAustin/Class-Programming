...
/// It uses a non-recursive operation (called atomicoperation).
/// This prevents recursive operations on the leaves.
/// But you still have to find if it is a Composite object, and then iterate on it.
...
class Leaf extends Component {
    ...
    public void atomicoperation() {
        System.out.println("Leaf.atomicoperation()");
    }
...
class Composite extends Component {
    ...
    public void atomicoperation() {
        System.out.println("Composite.atomicoperation()");
    }
    public Iterator iterator() {
